# This source file is majorly based on Vocabulary from AllenNLP v0.8.3, who adopted the Apache license
# available at https://github.com/allenai/allennlp/blob/master/LICENSE
...
class NSVocabulary:
    """
    A vocabulary with namespace.
    Every namespace contains a mapping from string to integers, which plays an crucial roles in transformation
    of instances to tensors.
    ...
    def __init__(self,
        ...
        self.extend_from_counter(counter,
                                 min_count,
                                 max_vocab_size,
    ...
    @classmethod
    def from_files(cls, directory: str) -> 'NSVocabulary':
        """
        ...
        for namespace_filename in os.listdir(directory):
            ...
            is_padded = not namespace in non_padded_namespaces
    ...
    def extend_from_counter(self,
        ...
        for namespace in current_namespaces & extension_namespaces:
            ...
            original_padded = not namespace in self._non_padded_namespaces
            extension_padded = not namespace in non_padded_namespaces
            if original_padded != extension_padded:
                raise ValueError("Common namespace {} has conflicting ".format(namespace)+
